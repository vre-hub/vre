...
# database url as string and .yaml file  for secret containing username and password for the ESCAPE Service Account (sso)
DB_PATH="/root/clusters/vre-cluster/rucio-secrets/"
export DB_CONNECT_STRING="postgresql://admin:Neutrinos22@dbod-vre-rucio.cern.ch:6600/rucio"
